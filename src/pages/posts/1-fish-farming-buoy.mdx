...
description: "Developed a prototype battery-powered device using LoRaWAN to transmit water temperature, dissolved oxygen and pH for fish farming applications in Colombia. Project was distributed as open-source hardware and a peer-reviewed article was published."
image:
    url: "../assets/BuoyOperating.jpeg"
    alt: "A prototype buoy device for measuring water quality at fish farming lakes"
pubDate: 2025-09-12
